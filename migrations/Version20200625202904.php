 ...
 */
final class Version20200625202904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bet (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, excuse_id INT NOT NULL, excuse_of_the_day_id INT DEFAULT NULL, created_at DATETIME NOT NULL, finish_at DATETIME NOT NULL, is_archived TINYINT(1) NOT NULL, INDEX IDX_FBF0EC9BA76ED395 (user_id), INDEX IDX_FBF0EC9B45731166 (excuse_id), INDEX IDX_FBF0EC9BF9CE8D22 (excuse_of_the_day_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, last_bet_id INT DEFAULT NULL, excuse_of_the_day_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, birth_date DATE DEFAULT NULL, is_verified TINYINT(1) NOT NULL, can_bet TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D64952765EFC (last_bet_id), INDEX IDX_8D93D649F9CE8D22 (excuse_of_the_day_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
